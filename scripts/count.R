...
fc <- featureCounts(files=c(vectorInput),annot.ext=snakemake@config[["annotation"]],isGTFAnnotationFile=TRUE,GTF.featureType="exon",GTF.attrType="gene_id",nthreads=snakemake@threads)
